...
This is the branch experiment based 2, which uses the same embedding model for evaluation
"""
import pandas as pd
import sys_config
...
def run(book_i, book_name, book_file_name, threshold_for_filter=0.6):
    ...
    data_file_name = 'exp_2_rag_gpt_fix_evl_embedding'
